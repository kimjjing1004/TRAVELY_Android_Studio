...
//        val intent = Intent (this@CameraFragment.context, CameraActivity::class.java)
//
...
//        } else {
//            Toast.makeText(this@CameraFragment.context, "there isn't transferred name", Toast.LENGTH_SHORT).show()
//        }
